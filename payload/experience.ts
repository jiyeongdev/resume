  ...
  list: [
    {
      ...
      descriptions: [
        ...
        '권한 관리 시스템 개선을 주도하여 API 처리 시간을 98% 단축하고 사용자 경험 향상에 기여',
        '중복/불필요한 권한 체크 로직을 제거하고, 데이터 연관성을 분석하여 필요한 권한 데이터만 키-값 구조로 관리하여 DB 호출을 최대 20,000회에서 4회로 감소',
        '권한 관리 시스템의 안정성을 높이기 위한 테스트 자동화 도입 - DB 스냅샷을 활용한 테스트로 기존/개선 로직의 결과값과 성능을 자동으로 검증',
    ...
    },
    {
      ...
      descriptions: [
        ...
        'B2B 신규 서비스 구축 및 API 개발',
        'PHP, AuroaDB , redis 기반의 키오스크 서비스 개발',
