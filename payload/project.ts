          ...
          descriptions: [
            {
              ...
              descriptions: [
                ...
                {
                  content: 'Spring Security + OAuth2를 활용한 구글 소셜 로그인 및 JWT 기반 인증 시스템 구축',
                },
                {
                  content: '계층형 테이블 구조(대/중/소분류)를 활용한 식재료 카테고리 모델링 및 JPA/Hibernate로 구현',
                },
                {
            ...
            },
            {
              ...
              descriptions: [
                {
                  content: 'Python 기반 AI 이미지 생성 서버 구축 - Stable Diffusion v1.5(runwayml) 모델 활용',
                },
                {
                  content: 'Groq API(Llama 3.3 70B)를 활용한 한→영 번역 최적화 및 프롬프트 엔지니어링',
                },
                {
                  content: 'Pandas, NumPy를 활용한 14만건 식재료 데이터 전처리 및 1만건 고유 데이터셋 구축',
                },
                {
      ...
      descriptions: [
        {
          ...
          descriptions: [
            {
              content: '파편화된 정보를 한눈에 모아 TTS 알람, 푸시알림, 위젯으로 정보를 제공하는 알람 서비스',
            },
            {
        ...
        },
        {
          ...
          descriptions: [
            {
              content: '공공 데이터 API로 실시간 버스 위치 정보, 실시간 날씨 정보, 실시간 코로나 정보를 가져와 전처리를 거쳐 데이터를 제공',
            },
            {
