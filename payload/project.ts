  ...
  list: [

    {
      ...
      descriptions: [
        ...
        {
          content: '캐시 도입을 통한 DB 호출 최적화 - 최대 20,000회 → 최대 4회로 99.98% 감소 및 서버 리소스 사용량 75% 감소',
        },
        {
          content: 'DB 스냅샷 기반 테스트 자동화 구축 - 기존/개선 로직 간 권한 체크 결과값 검증 및 성능 측정 자동화 - 테스트 몇개했다 추가하기!!!',
        },
...

    {
      ...
      descriptions: [
        {
          content: '동접자 수 1,000 ~ 3,000명과 회원 수 180만명의 대용량 데이터를 처리하기 위한 스터디카페 키오스크 서비스 개선 프로젝트',
          descriptions: [
            {
            ...
            {
              content: 'WebSocket 기반 10초마다 좌석배치도 업데이트 로직을 Redis Pub/Sub 아키텍처로 전환하여 서버 부하 감소 및 실시간성 개선',
            },
            {
              content: '좌석배치도/이용권 약 10만개의 대용량 데이터를 DB 신규 설계하여 조회시간 10초대 → 3초대 개선 ',
            },
            {
      ...
      descriptions: [
        {
          ...
          descriptions: [
            ...
            {
              content: '타 부서에서 제공하는 엑셀 데이터를 수동으로 입력하는 방식에서 Google AppScript 도입으로 송출데이터 자동화 시스템 개발 및 팀 내 공유',
            },
            {
    ...
    },
    {
      ...
      descriptions: [
        {
          content: 'Shorten URL 페이지로 SW수강생들이 신청을 하면 제휴코드를 발급해주고, 스터디룸을 이용할 수 있는 신규 프로젝트',
          descriptions: [
            {
      ...
      descriptions: [
        {
          ...
          descriptions: [
            ...
            {
              content: '12만개의 좌석 별 이용시간 통계표를 개발하여 어떤 좌석이 인기가 많고 적은지를 알 수 있는 기반을 제공 -12만개 좌석 데이터 기반의 실시간 이용률 분석 시스템 구축',
            },
          ],
        },
      ],
      ...
      descriptions: [
        {
          ...
          descriptions: [
            ...
            {
              content: 'Jenkins로 빌드 → scp를 통해 서버로 build파일 전송 → 배포 스크립트 실행 → 배포 완료',
            },
            {
    ...
    },
    {
      ...
      descriptions: [
        {
          content: '전국 150여개의 매장에서 운영 중인 M&A 스터디카페 키오스크 서비스와 관리자 페이지',
          contribution: '100% 기여',
          descriptions: [
            {
    ...
    },
    {
      ...
      descriptions: [
        ...
        { 
          content :"skill : Node.js, PHP, MariaDB, Firebase Realtime Database, Nginx, 공공데이터 포털 API",
        }
      ],
    }
  ],
